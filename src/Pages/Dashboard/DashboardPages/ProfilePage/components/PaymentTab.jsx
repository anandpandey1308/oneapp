  ...
  const paymentCardData = [
    {
      ...
      description: "View all transactions right within your SuperProfile dashboard."
    },
    {
    ...
    },
    {
      ...
      description: "All your earnings are settled to your bank account regularly."
    },
  ];
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="shadow-md rounded-lg p-4 md:p-6 flex flex-col gap-4 bg-white">
        ...
        <div className="flex justify-between items-center">
          <h2 className="text-sm md:text-lg font-semibold">
            SuperProfile payments
          </h2>
          <div className={`border rounded-xl ${userKYCStatus.color} text-[10px] md:text-sm px-2 py-1 mt-3 md:mt-0`}>
      ...
      <div className="shadow-md rounded-lg p-4 md:p-6 flex flex-col gap-4 bg-white">
        ...
        <span className="text-xs text-gray-500">Want to enable GST on your product sales? Set it here.</span>
