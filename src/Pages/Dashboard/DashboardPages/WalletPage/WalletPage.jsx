          ...
          {modal && (
            <div className="bg-white absolute z-20 top-36 right-[42px] md:top-20 md:right-14  w-60 py-1 pr-3 rounded-md shadow-md">
              <a
                ...
                className="cursor-pointer hover:bg-[#eff4f5] transition-transform ease-out duration-300 transform hover:translate-x-2 font-poppins text-sm text-gray-800 py-2 px-3 tracking-tight flex gap-3 items-center"
              >
                {" "}
              ...
              <a
                ...
                className="cursor-pointer hover:bg-[#EFF4F5] transition-transform   ease-in-out duration-300 transform hover:translate-x-2 font-poppins text-sm text-gray-800 py-2 px-3 tracking-tight flex gap-3 items-center"
              >
                {" "}
        ...
        <div className="my-4 flex flex-col md:flex-row justify-between md:items-center gap-6">
          ...
          <div className="flex flex-col gap-1">
            ...
            <h2 className="font-bold tracking-tight font-poppins text-3xl flex gap-1">
              ...
              <CountUp
                start={0}
                end={walletConfig.walletPage.amount}
                duration={2}
              />
            </h2>
            <p className="font-poppins tracking-tight text-sm text-gray-500">
              Last Updated on {walletConfig.walletPage.updatedAt}
            </p>
          </div>
          ...
          <div className="flex flex-col gap-3 ">
            ...
            <button
              ...
              className="py-2 px-3 bg-[#FA6E25] font-poppins text-white rounded-md"
            >
              Withdraw amount
            </button>
          </div>
        ...
        <div className="py-8 relative px-3 flex justify-between w-full bg-gradient-to-r from-[#f96e25] to-[#f89e6f] rounded-2xl">
          <div className="flex flex-col gap-3">
            ...
            <h2 className="font-bold text-3xl text-white tracking-tight">
              ...
              <CountUp
                start={0}
                end={walletConfig.walletPage.totalEarnings}
                duration={2}
              />
            </h2>
          </div>
          ...
          <div className="absolute top-3 right-3">
            <div className="relative bg-white rounded-md border border-gray-300 py-2 px-3 flex items-center gap-2 cursor-pointer shadow-sm">
              <select
                className="bg-transparent text-sm font-poppins cursor-pointer outline-none"
        ...
        <div className="py-8 px-3 relative bg-gradient-to-r from-green-500 to-[#8bd1a5] w-full rounded-2xl">
          <div className="flex flex-col gap-3">
            ...
            <h2 className="font-bold text-3xl text-white tracking-tight">
              ...
              <CountUp
                start={0}
                end={walletConfig.walletPage.totalWithDrawals}
                duration={2}
              />
            </h2>
          </div>
        ...
        <div className="bg-white w-full  py-3 px-3 mt-5 rounded-xl">
          <div className="flex bg-[#eff4f5] py-3 justify-between items-center rounded-xl px-3 ">
            <div className="flex gap-3 items-center">
              ...
              <p className="font-poppins text-sm md:text-md tracking-tight">
                Your KYC is Pending complete is asap to withdraw your wallet
                amount!
              </p>
            </div>
            <button className="bg-[#f96e25] py-2 px-3 text-sm rounded-md text-white font-poppins">
              Update
            </button>
          </div>
        </div>
            ...
            {walletConfig.walletPage.recentWithdrawals.map(
              (withdrawal, index) => (
                ...
                >
                  ...
                  {/* Amount*/}
                  <p className="font-semibold font-poppins tracking-tight">
                    ₹ {withdrawal.amount}
                  </p>
                </div>
              )
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 w-96 shadow-lg">
            ...
            <input
              ...
              className="w-full px-3 py-2 border rounded-md mb-4 focus:outline-none focus:ring-2 focus:ring-[#FA6E25]"
            />
            <div className="flex justify-end gap-4">
              ...
              <button
                ...
                className="px-4 py-2 bg-[#FA6E25] text-white rounded-md hover:bg-[#e65c19]"
              >
                Withdraw
              </button>
            </div>
