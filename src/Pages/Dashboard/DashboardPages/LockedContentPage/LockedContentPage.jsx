...
const LockedContentPage = () => {
  ...
  return (
    <div className="min-h-screen">
      {/* Background Section */}
      <div className="w-full h-64 bg-gradient-to-r from-[#0000FF] to-[#FFD700] flex justify-center items-center relative">
        <h1 className="font-bold text-white text-3xl md:text-4xl">Locked Content</h1>
        <button
          type="button"
          ...
          aria-label="Create Locked Content"
        >
      ...
      <div className="p-6 h-full w-full flex items-center justify-center">
        {tabContent[activeTab].content ? (
          ...
          <NoContentComponent
            title={noContentData.lockedContent[activeTab].title} 
            description={noContentData.lockedContent[activeTab].description} 
            isbutton={noContentData.lockedContent[activeTab].isbutton} 
            button_title={noContentData.lockedContent[activeTab].button_title}
          />
        )}
      </div>
    </div>
